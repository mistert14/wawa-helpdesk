...
// date: 2009/04/28 11:18:47
  ...
  'cache_dir' => '/usr/share/lcs/helpdesk/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/usr/share/lcs/helpdesk/cache/frontend/prod/config/routing',
  'lifetime' => 31556926,
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/usr/share/lcs/helpdesk/cache/frontend/prod/template',
  'lifetime' => 86400,
